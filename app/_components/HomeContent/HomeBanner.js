...
export default function HomeBanner() {
  return (
    <section className="home relative min-h-screen w-full xs:aspect-[2/1] md:aspect-auto">
      <Swiper
        speed={3000}
        pagination={true}
        autoplay={{
            ...
            >
              <div className="text-white">
                <h2
                  ...
                  className="title md:text-6xl text-2xl mb-0.5 md:mb-2"
                >
                  قهوه تیست
                </h2>
                <span
                  data-swiper-parallax="-200"
                  className="subtitle md:text-5xl text-xl"
                >
                  یک فنجان قهوه
                </span>
                ...
                <p
                  ...
                  className="text md:text-2xl text-xs max-w-[201px] md:max-w-[460px]"
                >
                  تجربه ای متفاوت از طعم واقعی قهوه
                </p>
              </div>
            </div>
          </div>
            ...
            >
              <div className="text-white">
                ...
                <p
                  ...
                  className="text md:text-2xl text-xs max-w-[201px] md:max-w-[460px]"
                >
                  با نوشیدن یک فنجان شما اد دیگری میشوید
                </p>
              </div>
            </div>
          </div>
            ...
            >
              <div className="text-white">
                ...
                <span
                  ...
                  className="subtitle md:text-5xl text-xl"
                >
                  قهوه هایی از دل جزایر ناشناخته
                </span>
                <span className="w-[100px] h-px md:h-0.5 block bg-orange-300 my-3 md:my-8"></span>
                <p
                  data-swiper-parallax="-100"
            ...
            >
              <div className="text-white">
                ...
                <span
                  ...
                  className="subtitle md:text-5xl text-xl"
                >
                  نوشیدنی از لابلای جنگل های بهشت
                </span>
                <span className="w-[100px] h-px md:h-0.5 block bg-orange-300 my-3 md:my-8"></span>
                <p
                  data-swiper-parallax="-100"
                  className="text md:text-2xl text-xs max-w-[201px] md:max-w-[460px]"
                >
                  با خرید قهوه تیست دیگر نگران کافيین خود نباشید
                </p>
              </div>
            </div>
          </div>
